...
- The microcontroller used is ESP32 which performs good enough in bluetoth data transfer with its built in bluetoth and is quite affordable.
...
After the project is finished ı am thinking about giving it to my 8 years old cousin as a gift. So the projects purpose can be concluded as making children and F1 lovers (like me) happy!
# Credits
This project uses:
- Fuion 360
- KiCAD
